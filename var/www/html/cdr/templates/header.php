...
<body>
<ul>
  <li><a href="../queues/index.html">Очереди вызовов</a></li>
  <li><a href="../congestion/index.html">Текущие разговоры</a></li>
  <li><a href="../conf/index.html">Конференция</a></li>
  <li><a class="active" href="../cdr/index.php">История звонков</a></li>
</ul>
<div id="container">
	<table id="header">
		<tr>
